            ...
            <div class="isotope-item photos col-sm-2 col-md-2 col-lg-2">
                <div class="thumbnail">
                        ...
                        <div class="mg-thumb-options">
                            ...
                            <div class="mg-toolbar">
                                <div class="mg-group float-right">
                                    <a class="simple-ajax-modal btn btn-<?= $warna ?>" href="ajax/<?= $form ?>?id=<?= htmlspecialchars($br['id_barang']) ?>&k=<?= urlencode($k) ?>"><?= $link ?></a>
                    ...
                    <div class="mg-description">
                        <small class="float-left text-muted"><?= htmlspecialchars($br['jumlah_stok']) ?> <?= htmlspecialchars($br['satuan']) ?></small>
...
<?php endforeach; ?>
            <div class="alert alert-danger w-100">
                ...
                <a href="ajax/pesan2.php" class="simple-ajax-modal alert-link">Klik Disini</a> untuk mengajukan pemesanan barang.
            </div>
        </div>
    </div>
</section>

                            ...
                            <ul class="nav nav-children">
                                ...
                                <li class="nav-parent">
                                    ...
                                    <?php
                                        ...
                                        if (count($skat) > 0) {
                                            echo "<li><a class='nav-link' href='?p=kat'></a></li>";
                                            foreach ($skat as $kat) {
...
?>
                        <li>
                            <a class="nav-link" href="?p=menipis">
                                ...
                                <span>BARANG HAMPIR HABIS <span class="float-right badge badge-danger"><?= $hampir ?></span></span>
                            </a>                        
                        </li>
                        <li>
                        ...
                        <li class="nav-parent">
                            ...
                            <ul class="nav nav-children">
                                <li class="nav-parent">
                                    <a>
                                        DATA PETUGAS <i class="fas fa-users"></i> 
                                    </a>
                                    <ul class="nav nav-children">
                                    <?php
                                        $sbag = db_fetch_all($bp, "SELECT id_seksi, bagian FROM bagian ORDER BY urutan");
                                        if (count($sbag) > 0) {
                                            echo "<li><a class='nav-link' href='?p=petugas'>Semua Bagian</a></li>";
                                            foreach ($sbag as $bag) {
                                                echo "<li><a class='nav-link' href='?p=petugas&bag=" . htmlspecialchars($bag['id_seksi']) . "&bag_nm=" . htmlspecialchars($bag['bagian']) . "'>" . htmlspecialchars($bag['bagian']) . "</a></li>";
                                            }
                                        }
                                    ?>
                                        <li>

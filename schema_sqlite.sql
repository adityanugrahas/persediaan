-- ============================================================
-- SQLite Schema for Persediaan (Inventory Management)
-- Translated from PostgreSQL schema for local development
-- ============================================================
...
CREATE TABLE IF NOT EXISTS notif (
  ...
  tgl_notif   DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS bmn_dist (
  ...
  lokasi         VARCHAR(50) NOT NULL DEFAULT '',
  kondisi        VARCHAR(50) NOT NULL DEFAULT '',
  tgl_dist       DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Default setting
INSERT OR IGNORE INTO setting (setting_id, title_head, nama_kantor, alamat_kantor, telp_kantor, email_kantor, logo_header) VALUES
('20210212131943', 'IMIGRASI KARAWANG', 'KANTOR IMIGRASI KELAS I NON TPI KARAWANG', 'JL. JEND. AHAMAD YANI  NO 18 (BY PASS) KARAWANG', '081222311607', 'kanim2karawang@gmail.com', 'logo-placeholder.png');

-- Default bagian (sections)
INSERT OR IGNORE INTO bagian (id_seksi, induk, bagian, keterangan, urutan) VALUES
...
INSERT OR IGNORE INTO petugas (id_petugas, users_id, pwd, nama, seksi, jabatan, p_level, photo, ttd, last_in, last_out, urutan, p_status) VALUES
('20210212134326', 'admin', 'admin', 'Administrator', '210510023455', '', 'su', '', '', '', '', 0, 'aktif');

-- Sample categories
INSERT OR IGNORE INTO kategori (id_kat, editor, nama_kat, ket_kat, status) VALUES
...
('210524021544', '', 'Dokim', 'Seluruh Dokumen Keimigrasian Paspor, E-KITAP, perdim dll', 'ON');

-- Sample BMN categories
INSERT OR IGNORE INTO kat_bmn (id_kat, editor, nama_kat, ket_kat, status) VALUES
('210421110233', '', 'Pengolah Data', 'PC, Laptop, Printer dll', 'on'),
('210421114425', '', 'Kendaraan Operasional', 'Mobil, Motor dll.', 'on');

-- Sample stock items
INSERT OR IGNORE INTO stok_barang (id_barang, kategori, nama_barang, jumlah_stok, satuan, harga_satuan, stok_minimal, keterangan, gambar, aktif) VALUES
('21050768', '210524022605', 'KERTAS HVS UKURAN A4', 110, 'rim', 36300, 5, '', '', 'ya'),
('21050769', '210524022605', 'KERTAS HVS F4 70 GRM', 105, 'rim', 41800, 5, '', '', 'ya'),
('21050701', '210524021730', 'SPIDOL UK.KECIL WARNA HIJAU', 50, 'pcs', 13200, 5, '', '', 'ya'),
('21050702', '210524021730', 'SPIDOL KECIL UK.KECIL WARNA HITAM', 30, 'pcs', 13200, 5, '', '', 'ya'),
('21050712', '210524021730', 'PULPEN PILOT', 48, 'pcs', 22000, 5, '', '', 'ya'),
('21050722', '210524021832', 'TINTA STEMPEL WARNA VIOLET', 35, 'pcs', 31900, 5, '', '', 'ya'),
('21050728', '210524022537', 'STAPLER 23/6 UK.BESAR', 10, 'pcs', 104500, 5, '', '', 'ya'),
('21050729', '210524022537', 'STAPLER HD 10 UK.KECIL', 138, 'pcs', 53900, 5, '', '', 'ya'),
('21050839', '210524022002', 'Baterai AA', 0, 'pcs', 0, 5, '', '', 'ya'),
('21050842', '210524024546', 'Masker', 0, 'pcs', 0, 5, '', '', 'ya');

-- Sample BMN items
INSERT OR IGNORE INTO bmn (id_bmn, kat_bmn, kode_bmn, nama_bmn, jumlah_bmn, satuan, harga_satuan, asal_oleh, tgl_oleh, bukti_oleh, harga_oleh, stok_minimal, keterangan, gambar, aktif, pengguna, lokasi, kondisi) VALUES
('210422073904', '210421110233', 'Pngadaan', 'Laptop', 13, 'Unit', 0, 'Lp', '2021-04-22', 'BAST', 15000000, 0, 'Laptop HP', '', 'ya', '', '', ''),
('210421033809', '210421110233', 'pre2020', 'Printer Epsom', 12, 'Unit', 0, 'Beli', '2021-04-21', 'kwitansi', 12000000, 0, '', '', 'ya', '', '', ''),
('210422014928', '210421114425', 'bmt', 'Sepeda Motor', 10, 'Unit', 0, 'Pengadaan', '2021-04-22', 'BAST tgl bayar', 30000000, 0, 'Yamaha Enmek', '', 'ya', '', '', ''),
('210423085818', '210421114425', 'Mbl', 'Toyota Kijang', 2, 'unit', 0, 'Mbl', '2021-04-23', 'BAST tgl bayar', 30000000, 0, '', '', 'ya', '', '', '');
